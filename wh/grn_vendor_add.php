...
<table width="100%" id="itemsTable1" class="table table-bordered table-hover">
    ...
    <tbody>
		...
		<td class="col-md-2">
		<span id="brnd0">
            	<!--<select name="brand[0]" id="brand[0]" class="form-control selectpicker required" data-live-search="true"  required>-->
					<select name="brand[0]" id="brand[0]" class="form-control selectpicker required" data-live-search="true"  required>
        	...
        	<td class="col-md-2">
            	<span id="pdtid0">
                <select name="prod_code[0]" id="prod_code[0]" class="form-control required selectpicker" data-live-search="true"   required>
			...
			<td class="col-md-2"><span id="division0">
					   <select name="division[0]" id="division[0]" class="form-control selectpicker required"  data-live-search="true" onChange="getmodel(0);">
			...
			<!-- <td class="col-md-2" >
				<span id="modeldiv0">
					<select name="model[0]" id="model[0]" class='form-control required selectpicker' data-live-search='true'  onChange="getpartcode(0)" required>
			...
			<td class="col-md-1">
            	<input type="text" class="form-control " name="price[0]" id="price[0]"  autocomplete="off"  onKeyUp="get_tot(0);" style="width:100px;text-align:right;padding: 4px" readonly required>
            </td>
			<td class="col-md-2">
