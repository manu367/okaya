			 ...
			 <div class="form-group">
			  <table width="100%" id="itemsTable1" class="table table-bordered table-hover">
				 <thead>
				  ...
				  <th class="col-md-2" style="font-size:13px">Brand</th>
					 <th class="col-md-3" style="font-size:13px;">Product</th>
					   <th class="col-md-3" style="font-size:13px;">Division</th>
				 ...
				 <tbody>
				  ...
				  <td class="col-md-2">
					  <span id="brnd0">
					  <select name="brand[0]" id="brand[0]" class="form-control selectpicker required" onChange="" data-live-search="true" required>
					 ...
					 <td class="col-md-2"><span id="pdtid0">
					   <select name="prod_code[0]" id="prod_code[0]" class="form-control selectpicker required"  onChange="getmodel(0)" data-live-search="true" required>
