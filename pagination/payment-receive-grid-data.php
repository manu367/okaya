...
/// mode selection
$is_admin = ($_SESSION['utype'] == "admin")?true:false;
...
$sql = "SELECT *";
//cmnt by HK: $sql.=" FROM payment_details where to_location = '".$_SESSION['asc_code']."' ";
$sql.=" FROM payment_details where ".$condition;
