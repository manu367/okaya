...
$sql = "SELECT *";
$sql.=" FROM product_master where ".$status."";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = "<div align='center'><a href='add_product.php?op=Edit&id=".$row['product_id']."&status=".$_REQUEST['status']."".$pagenav."' title='view'><i class='fa fa-eye fa-lg faicon' title='view/edit product details'></i></a></div>";
