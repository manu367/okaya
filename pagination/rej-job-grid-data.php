...
$sql = "SELECT *";
$sql.=" FROM jobsheet_data where location_code='".$_SESSION['asc_code']."' and sub_status='2' and status='2'   and pen_status='2' ";
//echo $sql;
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    ////// display repair icon in case of open/pna/assign only
		...
		$ack = "<div align='center'><a href='reassigen_jobs.php?job_no=".$row['job_no']."".$pagenav."' title='go to Assign'><i class='fa fa-wrench fa-lg faicon' title='go to Assign'></i></a></div>";
