...
if($_REQUEST['product_name'] != ""){
	$product_id = "product_id = '".$_REQUEST['product_name']."'";
}else{
	$product_id = "1";
}
## selected  product name
if($_REQUEST['brand'] != ""){
	$brand_id = "brand_id = '".$_REQUEST['brand']."'";
}else{
	$brand_id = "1";
}
## selected  location
...
## selected  model
if($_REQUEST['modelid']!=""){
	$model_id="model_id  = '".$_REQUEST['modelid']."' and ".$product_id." and ".$brand_id;
}else if($_REQUEST['model']=="" && $_REQUEST['product_name']!="" && $_REQUEST['brand']!=""){
	$model_id= $product_id." and ".$brand_id;
}else{
	$model_id="  brand_id='' and product_id=''";
}

$mod_id = $product_id." and ".$brand_id;
## selected  Status
