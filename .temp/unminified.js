    ...
    var N = function (h) {
                ...
                if (((m = b[e]), (k = []), !m.sType && m._sManualType)) m.sType = m._sManualType;
                    ...
                    for (j = d.length; g < j; g++) {
                        ...
                        for (
                            h = c.length;
                            i < h &&
                            !(k[i] === l && (k[i] = A(a, i, e, "type")), (o = d[g](k[i], a)), !o || "html" === o);
                            i++
                        );
                        if (o) {
                            m.sType = o;
        ...
        function ia(a, b) {
            var c = [],
                ...
                o = function (a, b, c) {
                    "string" === typeof a &&
                        ((b = a.indexOf("@")),
                        -1 !== b && ((a = a.substring(b + 1)), (j["@" + a] = c.getAttribute(a))));
                },
                k = function (a) {
                    g = m[i];
            ...
            for (c = m.length; b < c; b++)
                (f = m[b]),
                    ...
                    a.oFeatures.bSort &&
                        ...
                        !1 !== f.bSortable &&
                            (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Ka(a, f.nTh, b))),
                ...
                if (0 !== i.length) {
                    ...
                    (c = f.sZeroRecords),
                        ...
                        (b[0] = h("<tr/>", { class: e ? d[0] : "" }).append(
                            h("<td />", { valign: "top", colSpan: Z(a), class: a.oClasses.sRowEmpty }).html(c)
                        )[0]);
                    ...
                    h("<div/>", { class: f.sScrollFoot })
                        ...
                        .append(
                            h("<div/>", { class: f.sScrollFootInner }).append(
                                n.removeAttr("id").css("margin-left", 0).append(b.children("tfoot"))
                            )
                        )
        ...
        function Ca(a) {
            ...
            if (!o && !f && !e && j == Z(a) && j == i.length) for (k = 0; k < j; k++) c[k].sWidth = s(i.eq(k).width());
                ...
                f && g
                    ? j.width(g)
                    : f
                      ? (j.css("width", "auto"), j.width() < m.offsetWidth && j.width(m.offsetWidth))
                      : e
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    k.iInitDisplayStart === l &&
                        ((k.iInitDisplayStart = g.iDisplayStart), (k._iDisplayStart = g.iDisplayStart));
        ...
        var bb = function (a) {
                ...
                b.length &&
                    a.length &&
                    ((a = b[0].aoData[a[0]]),
                    a._details && (a._details.remove(), (a._detailsShow = l), (a._details = l)));
            },
            Tb = function (a, b) {
                var c = a.context;
                    ...
                    h(a.nTable).on("order.dt.DT", function (f, g, h, i) {
                        if (a === g) {
                            ...
                            b.find("span." + d.sSortIcon)
                                ...
                                .addClass(
                                    i[e] == "asc" ? d.sSortJUIAsc : i[e] == "desc" ? d.sSortJUIDesc : c.sSortingClassJUI
                                );
                        }
                    });
                },
