...
if ($_REQUEST["model_sub_under_name"] != "")
	{
        ...
        $MOUNTH_SUB = $_REQUEST['mounth_sub'];

  


     $sql = "select MODEL_NAME,TIME,STATUS from report2 where model_sub_under_name = '".$MODEL_SUB_UNDER_NAME."' and status = '".$STATUS."' AND MOUNTH_SUB = '".$MOUNTH_SUB."'";
