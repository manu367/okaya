...
$(document).ready(function() {
	var dataTable = $('#joblist-grid').DataTable( {
		...
		//"order": [[ 0, "asc" ]],
		"ajax":{
			url :"../pagination/stock-grid-data_admin.php", // json datasource
