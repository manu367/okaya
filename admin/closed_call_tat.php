...
if($_POST["product"]!=""){
	...
	$prod_condi = " model_id in (select model_id from model_master where ".$brand_condi.")";
}
//////// 
...
$interval4 = 0;
$interval5 = 0;
$res_jd = mysqli_query($link1,"select datediff(close_date,open_date) as ageing from jobsheet_data where ".$loc_condi." and ".$prod_condi." and ".$ws_condi." and close_date!='0000-00-00' and ".$daterange."");
