...
$(document).ready(function() {
	var dataTable = $('#voc-grid').DataTable( {
		...
		"order": [[ 2, "asc" ]],
		"ajax":{
			url :"../pagination/defect-grid-data.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-bug"></i> Defect Master : defect_master</h2>
      <?php if($_REQUEST['msg']){?>
        ...
        <div class="form-group">
		  ...
		  <div class="col-md-6"><label class="col-md-5 control-label"></label>	  
			<div class="col-md-5" align="left">
			   ...
			   ?>
               <a href="excelexport.php?rname=<?=base64_encode("defectmaster")?>&rheader=<?=base64_encode("Defect Master")?>&status=<?=base64_encode($_GET['status'])?>" title="Export Defect details in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export Defect details in excel"></i></a>
               <?php
				//}
				?>
            </div>
      ...
      <form class="form-horizontal" role="form">
        <button title="Add New Defect" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='add_defect.php?op=Add<?=$pagenav?>'"><span>Add New Defect</span></button>&nbsp;&nbsp;
