...
$(document).ready(function() {
	var dataTable = $('#bank-grid').DataTable( {
		...
		"order": [[ 2, "asc" ]],
		"ajax":{
			url :"../pagination/pending-reason-grid.php", // json datasource
  ...
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      ...
      <form class="form-horizontal" role="form">
        <button title="Add New Pending Reason" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='add_pen_reason.php?op=Add<?=$pagenav?>'"><span>Add New Reason </span></button>&nbsp;&nbsp;
