...
if(document.login_form.pwd.value!="" && document.login_form.userid.value!=""){
...
<body>
  ...
  <div id="login">
  <form id="login_form" name="login_form" method="post" action="verify.php" onSubmit="return chk_data()">
  <?php
	...
	?>
  <div align="center" >
  <img src="images/canent.png" width="235px"><br>
  <br>
  </div>
    ...
    <div id="sign_in_options" class="field_container">
        ...
        <div class="clearfix" style="color:#FF0000"><samp class="errortext"><?php echo errorMsg($_REQUEST['msg']);?></samp></div>
      </div>
</form>
  <div id="dont_have_an_account">
    <DIV align="center">Copyright © Okaya 2025  . All Rights Reserved. Powered By : <A href="http://www.candoursoft.com/" target="_blank">CANDOUR SOFTWARE</A></DIV>
