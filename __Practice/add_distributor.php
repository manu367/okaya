                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-5">
                                <input id="phone" name="phone" class="form-control" placeholder="10 Digit Mobile" value="<?=$loader['phone']??''?>">
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-5">
                                <input id="pincode" name="pincode" class="form-control" placeholder="6 Digit Pin" value="<?=$loader['pincode']??''?>">
                            </div>
                        </div>
