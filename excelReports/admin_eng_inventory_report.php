...
if($location_code != ""){
	...
	$locationid = " and a.location_code = '".$location_code."'";
}else{
	$locationid=" ";
}
## selected  product
...
//  echo "SELECT a.*, b.part_name, b.product_id, b.brand_id, b.customer_price  FROM user_inventory a, partcode_master b where a.partcode=b.partcode ".$locationid." ".$productid." ".$brandid."  ".$modelid."";

//  die;
$sql_loc=mysqli_query($link1,"SELECT a.*, b.part_name, b.product_id, b.brand_id, b.customer_price  FROM user_inventory a, partcode_master b where a.partcode=b.partcode ".$locationid." ".$productid." ".$brandid."  ".$modelid."");
...
$objPHPExcel->setActiveSheetIndex(0)
			...
			->setCellValue('Q'.$i, getAnyDetails($row_loc['location_code'],"locationname","location_code","location_master",$link1))
			->setCellValue('R'.$i, $row_loc['location_code']);
