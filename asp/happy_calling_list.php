...
$(document).ready(function() {
	var dataTable = $('#joblist-grid').DataTable( {
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/happycalling-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				$(".job-grid-error").html("");
				$("#job-grid").append('<tbody class="job-grid-error"><tr><th colspan="11">No data found in the server</th></tr></tbody>');
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-volume-control-phone"></i> Happy Calling</h2>
      <?php if($_REQUEST['msg']){?>
         ...
         <div class="col-md-6"><label class="col-md-5 control-label"><?=$locationstr?></label>	  
		  ...
		  <div class="col-md-6"><label class="col-md-4 control-label">Model</label>	  
			<div class="col-md-6">
                ...
                <select name="modelid" id="modelid" class="form-control" style="width:150px;" onChange="document.form1.submit();" >
                	<option value="">--All--</option>
                    <?php 
					$model_query="SELECT model_id, model FROM model_master where product_id = '".$_REQUEST['product_name']."' and brand_id='".$_REQUEST['brand']."' order by model";
