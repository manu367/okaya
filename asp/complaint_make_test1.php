...
////// final submit customer form ////

if($_POST['savecustomer']=='Save')
{
...
//////////////////////////////customer details//////////////////////////////////////////
	...
	mysqli_commit($link1);
		...
		$msg="You have successfully created customer and Customer id is <span class='red_small'> ".$cust_id." </span>";
...
header("location:complaint_make_test1.php?msg=".$msg."&chkflag=".$cflag."&chkmsg=".$cmsg."".$pagenav."&mobileno=".$phone1."&customer_id=".$customer_id."&email_id=".$email."&contactno1=".$row_loc['contactno1']."&status=1");
...
if($result_find_count > 0){
	...
	if($customer_name=='' || $address=='' || $pincode='' || $locationcity=='' || $locationstate=='' || $customer_type==''){
	 $flag = false;
	 $error_msg = "Error customer details: The field for Customer details is mandatory(customer name, address, pincode, location city, location state, customer type).";
	}
...
$product_det = mysqli_fetch_assoc(
        mysqli_query($link1,
                "SELECT * FROM product_registered  where id='".$_REQUEST['id']."'")
);
        ...
        $(document).ready(function () {
            $('#savejob').click(function () {
                ...
                if (locationstate == '' ||
                    ...
                    locationcity == '' ||
                    address == '') {
                    confirm("Error customer details: The field for Customer details is mandatory(customer name, address, pincode, location city, location state, customer type).");
                }
            });
        });
...
<!--                            customer category and pin-code-->
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="col-md-6 custom_label">
                                        Pin Code<span class="red_small">*</span>
                                    </label>
                                    <div class="col-md-6">
                                        ...
                                        <span class="red_small">
                                            OR You can use state/city/area option to find pincode
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="custo_id" id="custo_id" type="hidden"
                                    ...
                                    <div class="col-md-6" id="loc_pincodestate">
                                        <select name="locationstate" id="locationstate"
                                            ...
                                            while($row_res = mysqli_fetch_array($state_res)){?>
                                                <option value="<?=$row_res['stateid']?>" <?php
                                                if($row_customer['stateid']==$row_res['stateid']){
                                                    echo "selected" ;}?>>
                                                    <?=$row_res['state']?>
                                                </option>
                                            <?php }  ?>
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Landmark </label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="landmark" id="landmark" type="text" class="form-control "
                                               value="<?=ucwords($row_customer['landmark']);?>"
                                               style="text-transform: uppercase;" />

                                    </div>

                                </div>
                                <div class="col-md-6"><label class="col-md-6 custom_label">City <span
                                                class="red_small">*</span></label>
                                    ...
                                    <div class="col-md-6" id="citydiv">
                                        ...
                                        <select name="locationcity" id="locationcity"
                                            ...
                                            while($row_city = mysqli_fetch_array($city_res)){
                                                ...
                                                <option value="<?=$row_city['cityid']?>" <?php
                                                if($row_customer['cityid']==$row_city['cityid']){
                                                    echo "selected" ;}?>>
                                                    <?=$row_city['city']?>
                                                </option>
...
<!--                            contact and area-->
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="col-md-6 custom_label">
                                        Contact No
                                        <span class="red_small">(For SMS Update)</span>
                                        <span class="red_small">*</span>
                                    </label>
                                    <div class="col-md-6">
                                        <input name="phone1" type="text"
                                               ...
                                               value="<?php if($row_customer['mobile']!=''){ echo $row_customer['mobile'];}else{ echo $_REQUEST['mobileno'];}?>"
                                                <?php if($row_customer['mobile']!='' || $_REQUEST['mobileno'] !=""
                                                ){?> readonly
                                                <?php }else{}?>>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6" id="Areadiv">
                                        <select name="locationarea" id="locationarea" class="form-control">
                                            ...
                                            while($rowpin_area = mysqli_fetch_array($respin_area)){
                                                ?>
                                                <option value='<?php echo $rowpin_area['
														area']."~".$rowpin_area['pincode'];?>'
                                                        <?php if($rowpin_area['area']."~".$rowpin_area['pincode']==$row_customer['custarea']){ echo "selected";}?>>
                                                    <?php echo $rowpin_area['area']?>
                                                </option>
                                                <?php
                                            }
                                            ?>
...
<!--                            Address and Email-->
                            <div class="form-group">
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Address <span
                                                class="red_small">*</span></label>
                                    ...
                                    <div class="col-md-6">
												...
												<textarea name="address" id="address" required class="form-control"
                                                          ...
                                                          style="resize:vertical;text-transform: uppercase;"><?=ucwords($row_customer['address1']);?></textarea>
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Email</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="email" type="email" class="email form-control" id="email"
                                               value="<?=$row_customer['email'];?>"
                                               style="text-transform: uppercase;">
...
<!--                            Alternative contact and residence no-->
                            <div class="form-group">
                                <div class="col-md-6"><label class="col-md-6 custom_label">Alternate Contact
                                        No/Dealar No </label>
                                    <div class="col-md-6">
                                        <input name="phone2" type="text" class="digits form-control "
                                               id="phone2" maxlength="10"
                                               value="<?=$row_customer['alt_mobile'];?>">
                                    </div>
                                </div>
                                <div class="col-md-6"><label class="col-md-6 custom_label">Residence No</label>
                                    <div class="col-md-6">
                                        <input name="res_no" type="text" class="digits form-control" id="res_no"
...
<!--                            gst no and Registration Name -->
                            <div class="form-group">
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Registration
                                        Name</label>

                                    <div class="col-md-6">

                                        <input name="reg_name" type="text" class=" form-control" id="reg_name"
                                               value="<?=ucwords($row_customer['reg_name'])?>"
                                               style="text-transform: uppercase;">
                            ...
                            <div class="form-group">
                                <div class="col-md-12" align="center">
                                    ...
                                    <input type="submit" class="btn<?=$btncolor?>"
                                           name="savecustomer"
                                           id="savecustomer" value="Save" title="Save Job Details"
                                           <?php
                                           if($_POST['savecustomer']=='Save' ){?>disabled<?php }?>>&nbsp;
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--            product details and Observation form here -->
            <form name="frm1" id="frm1"
                  class="form-horizontal"
                  enctype="multipart/form-data"
                  autocomplete="off"
                  onsubmit="return really('save')" action="" method="post">

                <div class="panel-group">
<!--                    product detaisl info-->
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
<!--                             product and serial no-->
                            <div class="form-group">
                                <div class="col-md-6">
                                    <label class="col-md-6 custom_label">
                                        Product <span class="red_small">*</span>
                                    </label>
                                    <div class="col-md-6" id="productdiv">
                                        <select name="product_name" id="product_name"
                                                class="form-control required"
                                                onChange="resetProdModel();getprdwisebrand(this.value);"
                                                required>
                                            <?php
                                            if($product_det['product_id']==''){?>
                                                ...
                                                while($br_dept = mysqli_fetch_array($check_dept)){
                                                    ?>
                                                    <option value="<?=$br_dept['product_id']?>" <?php
                                                    if($sel_product==$br_dept['product_id']){ echo "selected" ;}?>>
                                                        <?php echo $br_dept['product_name']?>
                                                    </option>
                                                <?php }} else {?>
                                                <option value='<?=$product_det[' product_id']?>'>
                                                    <?=getAnyDetails($product_det['product_id'],"product_name","product_id","product_master",$link1);?>
                                                </option>
                                            <?php }?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <label class="col-md-4 custom_label"><?php echo SERIALNO ?></label>
                                    <div class="col-md-8">
                                        <input name="imei_serial1" id="imei_serial1" type="text"
                                               value="<?=$_REQUEST['imei_serial']?>"
                                               class="form-control required alphanumeric" minlength='10'
                                               maxlength="26"
                                               style="text-transform: uppercase;float: left;"
                                                <?php if($product_det['serial_no']!='' ){?> readonly
                                                <?php }else{
                                                }?> required />
                                        <input type="button" name="search_sr" id="search_sr"
                                               ...
                                               onClick="return getSerialdeatils();" value="Go!" />
                                    </div>
                                </div>
                            </div>
<!--                            modal and brand-->
                            <div class="form-group">
                                <div class="col-md-6">
                                    <label class="col-md-6 custom_label">
                                        Model <span class="red_small">*</span>
                                    </label>
                                    <div class="col-md-6" id="modeldiv">
                                        <select name="modelid" id="modelid"
                                            ...
                                            if($product_det['model_id']!=""){
                                                ...
                                                if($model_det2['7']!='N'){
                                                    ?>
                                                    <option value="<?=$product_det['model_id']."
														~".$model_det2['2']."~".$model_det2['6']."~".$model_det2['8'];?>
														">
                                                        <?=$model_det2['2']?>
                                                    </option>
                                                    <?php
                                                ...
                                                <option value="<?=$model_code."
														~".$model_name."~".$model_det2['8']."~".$model_det2['8'];?>">
                                                    <?=$model_det[2]?>
                                                </option>
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Brand <span
                                                class="red_small">*</span></label>
                                    <div class="col-md-6" id="selectedbrand">
                                        <select name="brand" id="brand" class="form-control required"
                                                onChange="getmaploc();resetProdModel();" required>
                                            <!--getmapbrand(this.value);--->
                                            <?php  if($product_det['brand_id']==''){?>
                                                ...
                                                while($br_dept = mysqli_fetch_array($check_dept)){
                                                    ?>
                                                    <option value="<?=$br_dept['brand_id']?>" <?php
                                                    if($sel_brand==$br_dept['brand_id']){ echo "selected" ;}?>>
                                                        <?php echo $br_dept['brand']?>
                                                    </option>
                                                <?php }} else {?>
                                                <option value='<?=$product_det[' brand_id']?>'>
                                                    <?=getAnyDetails($product_det['brand_id'],"brand","brand_id","brand_master",$link1);?>
                                                </option>
                                            <?php }?>
                                        </select>
                                    </div>
...
<!--                            bill purchase and warrenty end date-->
                            <div class="form-group">
                                <div class="col-md-6"><label class="col-md-6 custom_label">Bill Purchase Date
                                        <span class="red_small">*</span></label>
                                    <div class="col-md-6">
                                        <div style="display:inline-block;float:left;"><input type="text"
                                                                                             class="form-control required" name="pop_date" id="pop_date"
                                                                                             style="width:150px;"
                                                                                             value="<?php if($product_det['purchase_date']!=''){ echo $product_det['purchase_date'];?>  <?php }else{ echo "";}?>"
                                                                                             onChange="getdate4();"></div>
                                        <div style="display:inline-block;float:left;">
                                            <?php if($product_det['purchase_date']=='') {?><i
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Warranty End
                                        Date</label>

                                    <div class="col-md-6">

                                        <input name="warraty_date" id="warraty_date" type="text"
                                               value="<?=$product_det['warranty_end_date']?>" class="form-control"
                                               readonly />
                            ...
                            <div class="form-group">
                                <div class="col-md-6"><label class="col-md-6 custom_label">Date Of
                                        Installation</label>
                                    <div class="col-md-6">
                                        <div style="display:inline-block;float:left;"><input type="text"
                                                                                             class="form-control " name="install_date" id="install_date"
                                                                                             style="width:150px;"
                                                                                             value="<?=$product_det['installation_date'];?>" readonly></div>
                                        <div style="display:inline-block;float:left;"><i
                                                    class="fa fa-calendar fa-lg"></i></div>
                                    </div>
                                </div>

                                <div class="col-md-6"><label class="col-md-6 custom_label">Call Type <span
                                                class="red_small">*</span></label>

                                    <div class="col-md-6">

                                        <select name="call_for" id="call_for" class="form-control required"
                                                onchange="reinsallationfun();" required>
                  ...
                  ><option value='Dealer Stock Set Repair'>Dealer Stock Set Repair</option>
                     <option value='Split AC I/W Maintenance Service'>Split AC I/W Maintenance Service</option>
                       <option value='Annual Maintenance Contract (AMC)'>Annual Maintenance Contract (AMC)</option>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Warranty status<span
                                                class="red_small">*</span></label>

                                    <div class="col-md-6">

                                        <input name="warranty_status" id="warranty_status" type="text"
                                               value="<?=$ws?>" class="form-control " readonly />
                                        <input name="warranty_status1" id="warranty_status1" type="hidden"
                                               value="<?=$ws?>" class="form-control " readonly />
                                    </div>
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Dealer Name </label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="dealer_name" id="dealer_name" type="text" value=""
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Call source <span
                                                class="red_small">*</span></label>
                   ...
                   <option value='Distributor'>Distributor </option>-->
                                            <option value='Direct Walkin'>What's App </option>
              ...
              <!--    <option value='Social Media'>Social Media</option>
                  <option value='Web'>Web</option>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Purchase From
                                    </label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="entity_type" id="entity_type"
                                            ...
                                            while($br_entity = mysqli_fetch_array($check_enty)){
                                                ...
                                                ?>
                                                <option value="<?=$br_entity['id']?>" <?php
                                                if($_REQUEST['entity_type']==$br_entity['id']){ echo "selected"
                                                ;}?>>
                                                    <?php echo $br_entity['name']?>
                                                </option>
                                            <?php }?>
                                        </select>
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">Accessory
                                        Required</label>

                                    <div class="col-md-6" id="accdiv">

                                        <select name="acc_present[]" id="example-multiple-selected2"
                                            ...
                                            while($br_acc = mysqli_fetch_array($acc_part)){
                                                ...
                                                ?>
                                                <option value="<?=$br_acc['part_name']?>">
                                                    <?php echo $br_acc['part_name']?>
                                                </option>
                            ...
                            <div class="form-group">
                                <div class="col-md-6"><label class="col-md-6 custom_label">Assign Location
                                    </label>
                                    <!--  <div class="col-md-6" id="loc_pincode">-->
                                    <div class="col-md-6" id="loc_pincode">
                                        <select name="rep_location" id="rep_location"
                                                class="form-control required" required>
                                ...
                                <div class="col-md-6"><label class="col-md-6 custom_label">MFD</label>
                                    <div class="col-md-6">
                                        <input name="mfd" id="mfd" type="text" value="" class="form-control"
                                               readonly />
                                        <input name="mfd_ex" id="mfd_ex" type="hidden" value=""
                                               class="form-control" readonly />
                                        <input name="wp_days" id="wp_days" type="hidden" value=""
                                               class="form-control" readonly />
...
<!--                    Observation : voc_master-->
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;&nbsp;Observation
                        </div>
                        <div class="panel-body">
...
<!--                            voc master-->
                            <div class="form-group" id="vocdisplay">
                                <div class="col-md-6">
                                    <label class="col-md-6 custom_label">VOC <span class="red_small">*</span></label>
                                    <div class="col-md-6" id="vocdiv">
                                        <select name='voc1' id='voc1' class='form-control required' required>
                                            ...
                                            while($vocrow = mysqli_fetch_array($row_res)){
                                                ...
                                                if($vocrow['voc_code']==$job_det_t['cust_problem']){
                                                    echo "selected" ; } ?> >
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-6" id="mutlivoc">
                                        ...
                                        <select name="voc2[]" id="example-multiple-selected1"
                                            ...
                                            while($vocrow = mysqli_fetch_array($row_res)){
                                                ?>
                                                <option value="<?php echo $vocrow['voc_code']; ?>" <?php for($i=0;
                                                                                                             $i<count($vo22); $i++){ if($vo22[$i]==$vocrow['voc_code']) {
                                                    echo 'selected' ; }}?> >
                                                    <?php echo $vocrow['voc_desc']; ?>
                                                </option>
                                                <?php
                                    ...
                                    <div class="col-md-6">
                                        <input name="voc3" id="voc3" type="text" value="" class="form-control"
                                               placeholder="Enter Other VOC" />
                                    </div>
                                </div>
                            </div>
<!--                            remarks-->
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-9">
												<textarea name="remark" id="remark" class="form-control"
                                                          onkeypress=" return ( (event.keyCode ? event.keyCode : event.which ? event.which : event.charCode)!= 13);"
                                                          onContextMenu="return false"
                                                          style="text-transform: uppercase;resize:none;"><?=$ticket_det['remark']?></textarea>
                                    </div>
                                </div>
                            </div>
<!--                            image attachment-->
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <label class="custom_label">Image Attachement<br><span
                                                    style="color:#ff5f5f;font-weight:normal;">( png, jpg, pdf | max:
														3 MB )</span></label>
                                    </div>
                                    <div class="col-md-5" style="">

                                        <input type="file" name="handset_img" id="handset_img"
                                               onChange="return validateImage('handset_img','0');"
...
<!--                            video attachment-->
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <label class="custom_label">Video Attachement <br><span
                                                    style="color:#ff5f5f;font-weight:normal;">( mp4 | max: 10MB
														)</span></label>
                                    </div>
                                    <div class="col-md-5" style="">
                                        <input type="file" name="att_video" id="att_video"
                                               onChange="return validateVid('att_video','AV');"
                                               class="form-control" accept=".mp4" style="margin-bottom:10px;">
...
<!--                            button submit-->
                            <div class="form-group">
                                ...
                                <div class="col-md-12" align="center">
                                    ...
                                    <input title="Back" type="button" class="btn<?=$btncolor?>" value="Back"
                                           onClick="window.location.href='complaint_create.php?<?=$pagenav?>'">&nbsp;
                                    <input name="wsd" id="wsd" value="<?=$_REQUEST['p_wsd'];?>" type="hidden" />
                                    <input name="ticketno" id="ticketno"
                                           value="<?=base64_encode($ticket_det['ticket_no']);?>" type="hidden" />
                                    <input name="day_diff" id="day_diff" value="<?=$days_diference;?>"
                                           type="hidden" />

                                    <input name="symptom" id="symptom" value="<?=$count['symp_code']?>"
                                           type="hidden" />

                                    <input type="submit" class="btn<?=$btncolor?>" name="savejob" id="savejob"
                                           value="Save" title="Save Job Details" <?php if($_POST['savejob']=='Save'
                                           ){?>disabled
                                            <?php }?>>&nbsp;
...
<script>
    ...
    function getSerialdeatils() {
        ...
        ////1 D L1 B1 M01 W6 01 E Y3 0001   1DL1B1M01W601EY30001
    ...
    function chkModelSno(val, val2, ind) {
        ...
        if (val != "") {
            ...
            var strURL = "../includes/getField_warranty.php";
    ...
    function displayModel(result) {
        ...
        if (res1[0] != "") {
            ...
            $('#modeldiv').html(res1[1] + '<input type="hidden" name="modelid" id="modelid" value="' + res1[0] + '"/><input type="hidden" name="modelwp" id="modelwp" value="' + res1[2] + '~' + res1[3] + '"/>');
            if (res1[9] != "") {
                // making Purchase data as sale date from DB
                document.getElementById('pop_date').value = res1[9];
                getdate4();
            }
        }
        //$br['model_id']."^".$br['model']."^".$br['wp']."^".$br['dwp']."^".$brand_id['product_id']."^".$br['brand_id']."^".$product_name."^".$barnd_name."^".$_REQUEST['target'];
        ///document.getElementById('modelid').value.value=res1[0];
        // document.getElementById('modelid').value = res1[1]+"~"+res1[0]+"~"+res1[2];
        ////document.getElementById("warrantymonths["+indx+"]").value=res1[2];
        //getdate4();
    }
