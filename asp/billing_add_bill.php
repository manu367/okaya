               ...
               /// invoice counter  challanc number getereate karega
                ...
                if (mysqli_num_rows($res_invcount)) {
                 ...
                 $result = mysqli_query($link1, $query1);
                  ...
                  $inventory = mysqli_query($link1, "UPDATE client_inventory set okqty = okqty-'" . $sum_qty . "',updatedate='" . $datetime . "' where location_code='" . $parentcode . "' and partcode='" . $value . "' and  okqty >= '".$sum_qty."'");
...
<td><input type="text" class="number form-control" name="cost[0]"  id="cost[0]"  autocomplete="off" required style="width:71px;text-align:right;padding: 4px">
                                            <td><input type="text" class="number form-control" name="rowdiscount[0]" id="rowdiscount[0]" autocomplete="off" onBlur="rowTotal(0);" style="width:66px;text-align:right;padding: 4px"></td>
        ...
        <script>
            ...
            function getpartcode(indx){
                ...
                $.ajax({
                    ...
                    data:{modelbilling:model,indxx:indx},
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(getdata[0]  == "N"){
                            ...
                            alert("Serial No. is not available in your stock");
