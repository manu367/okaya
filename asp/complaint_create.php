        ...
        <div class="row content">
            ...
            <div class="<?=$screenwidth?>">
                <h2 align="center">
                    ...
                    Customer Registration/Call Booking
                </h2>
                <br /><br />
<!--                form-->
...
<!--                        mobile input-->
                        <div class="form-group">
                            <div class="col-md-10">
                                <label class="col-md-4 control-label">Mobile Number<?=$_REQUEST['msg']?></label>
                                <div class="col-md-6">
                                    <input type="text" name="mobileno" class="digits  form-control"
                                           id="mobileno"
                                           minlength="10"
                                           maxlength="10"
                                           value="<?=$_REQUEST['mobileno']?>"
...
<!--                        serial_no input-->
                        <div class="form-group">
                            <div class="col-md-10">
                                <label class="col-md-4 control-label"><?php echo SERIALNO ?></label>
                                <div class="col-md-6">
                                    <input type="text" name="imei_serial"
                                           class="form-control"
                                           maxlength="20"
                                           id="imei_serial"
                                           value="<?=$_REQUEST['imei_serial']?>"
                                           placeholder="Enter only <?php echo SERIALNO ?>" />
                                </div>
                            </div>
                        </div>
<!--                        button-->
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="col-md-6">
                                    <input type="submit"
                                           ...
                                           value="Search" title="Search" disabled>
                                </div>
                            </div>
                        </div>
                    ...
                    if(($_REQUEST['imei_serial']!='' ||
                            ...
                            $_REQUEST['email_id']!='' ) )
                    {
                    $cust_id=getAnyDetails($_REQUEST['imei_serial'],
                            "customer_id",
                            "serial_no",
                            "product_registered",
                            $link1);
                    if($_REQUEST['mobileno'])
                    {
                        $srch_criteria = "(mobile = '".$_REQUEST['mobileno'].
                                "'  or  alt_mobile  = '".$_REQUEST['mobileno']."') ";
                    ...
                    ?>
<!--                    customer details panel table views-->
                    <div class="panel panel-info">
                        <div class="panel-heading" align="center"> Customer Details - Customer_master </div>
                        <div class="panel-body">
                            <table class="table table-bordered" width="100%">
                                ...
                                <tbody>
                                <?php
                                $sql="select * from customer_master where ".$srch_criteria."order by id desc";
                                $sql_cust	= mysqli_query($link1, $sql);
                                $post_customerid="";
                                while($row_customer=mysqli_fetch_array($sql_cust)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo getAnyDetails($row_customer["stateid"],"state","stateid","state_master",$link1);?>
                                        </td>
                                        <td>
                                            <?php echo getAnyDetails($row_customer["cityid"],"city","cityid","city_master",$link1);?>
                                        </td>
                                        ...
                                        <td>
                                            <div align="center">
                                                <a href="customer_edit.php?customer_id=<?=$row_customer['customer_id']?>"".$pagenav."
                                                title='view'>
                                                <i class='fa fa-eye fa-lg faicon' title='view job details'></i>
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
...
<!--                    product_registered table data -->
                    <div class="panel panel-info">
                        <div class="panel-heading" align="center">Registered Product Details : product_registered</div>
                        <div class="panel-body">
                            <table class="table table-bordered" width="100%">
                                <thead>
                                <tr>
                                ...
                                list($flag1,
                                        ...
                                        $warratydate_arr,
                                        $id_arr)
                                        = getcustomerValidate($_POST['imei_serial'],
                                        $post_customerid,$link1);
                                ...
                                if($flag1=='Y'){
                                    for($k=0; $k<count($serial_arr); $k++){
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$serial_arr[$k]?></td>
                                            <td>
                                                <?=getAnyDetails($product_arr[$k],"product_name","product_id","product_master",$link1);?>
                                            </td>
                                            <td>
                                                <?=getAnyDetails($modelid_arr[$k],"model","model_id","model_master",$link1);?>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                echo $product_warr_st;?>
                                            </td>
                                            <td>
                                                <div align="center">
                                                    <a href="complaint_make.php?customer_id=<?=$customerid_arr[$k]?>&mobileno=<?=$_REQUEST['mobileno']?>&email_id=<?=$_REQUEST['email_id']?>&imei_serial=<?=$serial_arr[$k]?>&id=<?=$id_arr[$k]?>"".$pagenav."
                                                    title='view'>
                                                    <i class='fa fa-eye fa-lg faicon' title='view job details'></i>
                                                    </a>
                                                </div>
...
<!--                complaint history-->
                <div class="panel panel-info">
                    <div class="panel-heading" align="center">Complaint History : jobsheet_data</div>
                    <div class="panel-body">
                        <?php
                        $post_dop = "";
                        $post_activation = "";
                        ...
                        list($flag,
                                ...
                                $dop_arr,
                                $imei_arr,
                                $wsd_arr) = getcomplaintValidate($_REQUEST['imei_serial'],$_REQUEST['mobileno'],$_REQUEST['customer_id'],$link1);
                            ...
                            <table class="table table-bordered" width="100%">
                                ...
                                for($j=0; $j<count($jobno_arr); $j++){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div align="center">
                                                <a href="complaint_view_only.php?refid=<?=base64_encode($jobno_arr[$j])?>."".$pagenav."
                                                title='view'>
                                                <i class='fa fa-eye fa-lg faicon' title='view job details'></i>
                                                </a>
                                            </div>
                        ...
                        <div align="center">
                            <form id="frm4" name="frm4" class="form-horizontal" action="" method="">
                                ...
                                <input name="contact_no" id="contact_no" type="hidden"
                                       value="<?=$_POST['contact_no']?>" />
                                <input name="p_dop" id="p_dop" type="hidden" value="<?=$post_dop?>" />
                                <input name="p_activation" id="p_activation" type="hidden"
                                       value="<?=$post_activation?>" />
                                ...
                                <input name="ticket_no" id="ticket_no" type="hidden"
